    ...
    public class AddressModelsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var addressModel = await _context.Addresses
                .SingleOrDefaultAsync(m => m.AddressModelID == id);
        ...
        public async Task<IActionResult> Create([Bind("AddressModelID,Name")] AddressModel addressModel)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var addressModel = await _context.Addresses.SingleOrDefaultAsync(m => m.AddressModelID == id);
            if (addressModel == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AddressModelID,Name")] AddressModel addressModel)
        {
            if (id != addressModel.AddressModelID)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!AddressModelExists(addressModel.AddressModelID))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Addresses.Any(e => e.AddressModelID == id);
        }
    }
}
